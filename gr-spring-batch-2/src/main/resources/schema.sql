---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------
-- sudo psql -u postgres -d postgres_data_source -f src/main/resources/schema-postgresql.sql
---------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------

-- Schema for Spring Batch metadata tables in PostgreSQL
...
-- Optional: Create sequences for ID generation (if not using auto-increment)
